...
dates = DateTimeProlepticGregorian(2005, 1, 1) : Month(1) : DateTimeProlepticGregorian(2005, 12, 1)
...
# lat_index = searchsortedfirst(grid.φᵃᶜᵃ, 48)
# lon_index = searchsortedfirst(grid.λᶜᵃᵃ, 48)
